...
from mscproject.simulation.old.fba_model import FBAModel, growth_reaction_id, dir_path
...
class ETFLModel(FBAModel):
    def __init__(self, model_name='ecoli', solver_name='gurobi', conditions=None, pfba=False, sampling_n=0,
        ...
        if model_name == 'ecoli':
            ...
            name = 'iJO1366_T{:1}E{:1}N{:1}_{}_enz_{}_bins_{}.json'.format(has_thermo, True, has_neidhardt,
            ...
            self.model.growth_reaction.lower_bound = observed_growth - 3 * observed_growth_std
            self.model.repair()
            try:
